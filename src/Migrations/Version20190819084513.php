 ...
 */
final class Version20190819084513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD categorie_id INT DEFAULT NULL, ADD souscategorie_id INT DEFAULT NULL');
